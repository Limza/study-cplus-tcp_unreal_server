...
// string msg = 1;
inline void C_HELLOWORLD::clear_msg() {
  msg_.ClearToEmpty();
}
inline const std::string& C_HELLOWORLD::msg() const {
  // @@protoc_insertion_point(field_get:Protocol.C_HELLOWORLD.msg)
  return _internal_msg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void C_HELLOWORLD::set_msg(ArgT0&& arg0, ArgT... args) {
 
 msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.C_HELLOWORLD.msg)
}
inline std::string* C_HELLOWORLD::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:Protocol.C_HELLOWORLD.msg)
  return _s;
}
inline const std::string& C_HELLOWORLD::_internal_msg() const {
  return msg_.Get();
}
inline void C_HELLOWORLD::_internal_set_msg(const std::string& value) {
  
  msg_.Set(value, GetArenaForAllocation());
}
inline std::string* C_HELLOWORLD::_internal_mutable_msg() {
  
  return msg_.Mutable(GetArenaForAllocation());
}
inline std::string* C_HELLOWORLD::release_msg() {
  // @@protoc_insertion_point(field_release:Protocol.C_HELLOWORLD.msg)
  return msg_.Release();
}
inline void C_HELLOWORLD::set_allocated_msg(std::string* msg) {
  if (msg != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Protocol.C_HELLOWORLD.msg)
}
