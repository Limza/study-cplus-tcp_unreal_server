...
GetPackets.exe --path=./Protocol.proto --output=ClientPacketHandler --recv=S_ --send=C_
GetPackets.exe --path=./Protocol.proto --output=ServerPacketHandler --recv=C_ --send=S_
...
COPY /Y ServerPacketHandler.h "..\..\..\GameServer\ServerPacketHandler.h"
